...
text = "In the course of the twelve months that I remained in Bulawayo I made the acquaintance of a man named Elstop," \
       " who is mentioned by Mr. F. C. Selous in one of his books."
...
data.path.append('a_white_king_in_east_africa.txt')
